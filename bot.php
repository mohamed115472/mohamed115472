...
if($message and $text != "توجيه عام" and $text != "اذاعة كروبات" and $text != "توجيه" and $text != "اذاعة" and $text != "توجيه كروبات" and $text != "꙳. اذاعة" and $text != "꙳. توجيه" and $text != "꙳. اذاعة كروبات" and $text != "꙳. توجيه كروبات" and $text != "꙳. اذاعة عام" and $text != "꙳. توجيه عام" and $text != "꙳. الغاء الامر" and $Elalda8['data'] == "okoo" and in_array($from_id,$Dev)){
bot("sendmessage",[
"chat_id"=>$chat_id,
...
if($message and $text != "توجيه عام" and $text != "اذاعة كروبات" and $text != "توجيه" and $text != "اذاعة" and $text != "توجيه كروبات" and $text != "꙳. اذاعة" and $text != "꙳. توجيه" and $text != "꙳. اذاعة كروبات" and $text != "꙳. توجيه كروبات" and $text != "꙳. اذاعة عام" and $text != "꙳. توجيه عام" and $text != "꙳. الغاء الامر" and $Elalda8['data'] == "okkoo" and in_array($from_id,$Dev)){
bot("sendmessage",[
"chat_id"=>$chat_id,
...
$chall = $Elalda8["chall"];
if($text == "قناة الاشتراك" or $text == "꙳. قناة الاشتراك" and $Elalda8["chall"] != "Done"){
if (in_array($from_id,$Dev)) {
bot('sendmessage',[
'chat_id'=>$chat_id,
...
#----------(Elalda8)----------#
if($text=="꙳. المحظورين" and $Elalda8['ban'] != null){
$banlast = $Elalda8['ban'];
